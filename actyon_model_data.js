    ...
    technic_properties: [
      ...
      },
      {
        ...
        props: [
          ...
          {
            name: "Yükseklik",
            value: "1.670 Bagaj Portlu 1.680 mm",
          },
          {
            name: "Net Ağırlık",
            value: "1670 kg",
...
export const actyonColors = [
  {
    name: "Beyaz",
    image: require("./arac_gorseller/actyon/actyon_beyaz.png"),
  },
  {
    name: "Demir Metal",
    image: require("./arac_gorseller/actyon/actyon_demir_metal.png"),
  },
  {
    name: "Kraliyet Bakırı",
    image: require("./arac_gorseller/actyon/actyon_kraliyet_bakiri.png"),
  },
  {
    name: "Latte Bej",
    image: require("./arac_gorseller/actyon/actyon_latte_beji.png"),
  },
  {
    name: "Mavi",
    image: require("./arac_gorseller/actyon/actyon_mavi.png"),
  },
  {
    name: "Uzay Siyah",
    image: require("./arac_gorseller/actyon/actyon_uzay_siyahi.png"),
  },
  {
    name: "Orman Yeşili",
    image: require("./arac_gorseller/actyon/actyon_orman_yesili.png"),
  },
];
...
export const actyonGallery = [
  require("./actyon_gallery/actyon_gallery_1.jpg"),
  require("./actyon_gallery/actyon_gallery_2.jpg"),
  require("./actyon_gallery/actyon_gallery_3.jpg"),
  require("./actyon_gallery/actyon_gallery_4.jpg"),
  require("./actyon_gallery/actyon_gallery_5.jpg"),
  require("./actyon_gallery/actyon_gallery_6.jpg"),
  require("./actyon_gallery/actyon_gallery_7.jpg"),
  require("./actyon_gallery/actyon_gallery_8.jpg"),
  require("./actyon_gallery/actyon_gallery_9.jpg"),
];

export const actyonVideo = [
  {
    cover: require("./actyon_cover.jpg"),
    video: require("./actyon_video.mp4"),
  },
];
